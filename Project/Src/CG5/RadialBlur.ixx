export module Lumina.RadialBlur;
...
namespace Lumina {
	...
	public:
		...
		void Initialize(
			...
			auto settings{ Utils::LoadFromFile<nlohmann::json>("RadialBlur.json", "Assets/CG5") };
			auto rsSetup{ DX12::LoadRootSignatureSetup(settings.at("RS")) };
			RS_.Initialize(device_, rsSetup, "RadialBlur RS");
