export module Lumina.Vignetting;
...
namespace Lumina {
	...
	public:
		...
		void Initialize(
			...
			auto settings{ Utils::LoadFromFile<nlohmann::json>("Vignetting.json", "Assets/CG5") };
			auto rsSetup{ DX12::LoadRootSignatureSetup(settings.at("RS")) };
			RS_.Initialize(device_, rsSetup, "Vignetting RS");

			dxContext_.Compile(
				PS_,
				L"Assets/CG5/Vignetting.PS.hlsl",
				L"ps_6_6",
				L"main",
				"Vignetting.PS"
			);
			...
			Constants_.Scale = 32.0f;
			Constants_.Power = 0.5f;
